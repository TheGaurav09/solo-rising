...
import { Coffee, Award, Star, Heart, Users } from 'lucide-react';
          ...
          <AnimatedCard className="p-6">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-white/70">
                Be the first to join our Hall of Fame by completing workouts and earning achievements!
              </p>
            </div>
          </AnimatedCard>
        </div>
            ...
            <div className="text-center py-6">
              ...
              <a 
                ...
                className={`inline-block px-6 py-3 rounded-lg font-bold transition-all ${
                  ...
                  character === 'jin-woo' ? 'bg-jin-woo-primary hover:bg-jin-woo-primary/80 text-black' :
